...
```text
data/teams/lab/bss_balance.json       # 平衡队：Gholdengo + Dragonite + Ting-Lu 等
data/teams/lab/bss_sun.json           # 晴天队：Koraidon + Torkoal + Walking Wake 等
data/teams/lab/bss_trick_room.json    # 戏法空间队：Calyrex-Shadow + Ursaluna + Hatterene 等
```
